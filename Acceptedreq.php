        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="appointmentId" value="<?= $appointmentaccepted['id']; ?>">
                <b><input type="text" style="font-family: 'Poppins', sans-serif;cursor: pointer;" id="datepicker4" name="date1" class="form-control" required placeholder="Date1"></b><br>
                <b><input type="text" style="font-family: 'Poppins', sans-serif;cursor: pointer;" id="datepicker5" name="date2" class="form-control" placeholder="Date2*"></b><br>
                <b><input type="text" style="font-family: 'Poppins', sans-serif;cursor: pointer;" id="datepicker6" name="date3" class="form-control" placeholder="Date3*"></b><br>
