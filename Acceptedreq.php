        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="appointmentId" value="<?= $appointmentaccepted['id']; ?>">
                <b><input type="text" style="font-family: 'Poppins', sans-serif;cursor: pointer;" id="datepicker4" name="date1" class="form-control" required></b><br>
                <b><input type="text" style="font-family: 'Poppins', sans-serif;cursor: pointer;" id="datepicker5" name="date2" class="form-control"></b><br>
                <b><input type="text" style="font-family: 'Poppins', sans-serif;cursor: pointer;" id="datepicker6" name="date3" class="form-control"></b><br>
